...
import { privacyJsonLd } from '@/json-ld/privacy';
        ...
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <Content>
              ...
              look after your personal data when you use our GitHub App and
          ...
          <section>
            ...
            <Content className="mb-4">
              To provide the gamification service, we process the following
              data:
            </Content>
            <ul className="mb-4 list-disc space-y-2 pl-6">
              <Content as="li">
                <strong>GitHub Account Data:</strong> Username, Avatar, and
                GitHub User ID (via NextAuth).
              </Content>
              <Content as="li">
                ...
                (Advanced Encryption Standard) in our database. We cannot see
                your raw token, and it is only decrypted momentarily to send
                requests to Habitica on your behalf.
              </Content>
              <Content as="li">
                <strong>Webhook Data:</strong> Metadata about your GitHub
                activity (commits, pull requests, issue comments).
              </Content>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc space-y-2 pl-6">
              <Content as="li">
                ...
                http-only cookies (e.g., <code>next-auth.session-token</code>)
                to maintain your active session while you are logged in.
              </Content>
              <Content as="li">
                <strong>Preferences:</strong> We may use LocalStorage to
                remember your UI preferences (e.g., dismissing a welcome
                message).
              </Content>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Content>
                  To score your habits, we transmit command data (e.g.,
                  &#34;Score Up Task X&#34;) to the{' '}
                  <strong>Habitica API</strong>. This is necessary for the core
              ...
              <div>
                ...
                <Content>
                  ...
                  to monitor the performance and reliability of our website.
                  These tools collect anonymous usage data (e.g., page load
                  speeds, device type, and country). This data is aggregated and
                  does not identify individual visitors. We do not use tracking
