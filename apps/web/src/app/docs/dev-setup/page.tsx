    ...
    <>
      ...
      <div className="space-y-12 pb-20">
        <div>
          ...
          <Content size="lg">
            To contribute to <strong>Octogriffin</strong>, you need to set up
            the project locally. Follow this guide to get up and running in
            minutes.
          </Content>
        </div>
        ...
        <DocsStep step={2} heading="Create GitHub App">
          ...
          <div className="space-y-6">
            ...
            <Alert variant="warning" title="Important">
              ...
              generate a new{' '}
              <span className="font-mono font-bold">Client Secret</span>. You
              will need them for step 5.
            </Alert>
          </div>
        </DocsStep>
        ...
        <DocsStep step={6} heading="Start Database">
          ...
          <Alert variant="info">
            If you changed the DB credentials in the root .env, remember to
            update <code className="font-bold">DB_URL</code> in{' '}
